    ...
    addSeatCallback = ({ row, number, id }, addCb) => {
      ...
      render(){
        ...
        const rows = ()=> {
            allrows=
          [
          [{id: 1, number: 1,isReserved:false}, {id: 2, number: 2,isReserved:false},    {id: 3, number: '3',isReserved:false}, {id: 4, number: '4',isReserved:false},  {id: 5, number: 5,isReserved:false}, {id: 6, number: 6,isReserved:false}],
